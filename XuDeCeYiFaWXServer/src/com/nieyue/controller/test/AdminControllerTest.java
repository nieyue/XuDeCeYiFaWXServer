...
public class AdminControllerTest {
	...
	public void testBrowseMer() throws Exception {
		String url="/Admin/list.xml?orderName=update_date&orderWay=desc&pageNum=1&pageSize=3";
	...
	//聂跃","15111336587","278076304@qq.com","11874bb6149dd45428da628c9766b252",now(),now()
	@Test
	public void testaddMer() throws Exception {
		String url="/admin/add?name=聂跃&cellPhone=15111336587&email=278076304@qq.com&password=11874bb6149dd45428da628c9766b252";
		this.mvc.perform(get(url))
		//.andExpect(status().isOk())
		.andDo(print());
	} 
